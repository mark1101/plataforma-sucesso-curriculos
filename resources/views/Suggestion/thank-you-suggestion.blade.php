...
<head>
    ...
    <title>Obrigado pela sua sugestão</title>
</head>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-7 col-md-5">
                <div class="evaluate__thumb">
                    <img class="fr-desktop" src="assets/img/suggestion-thumb.svg" alt="">
                    <img class="fr-mobile d-none" src="assets/img/thumb/suggestion-thumb-2.png" alt="">
                </div>
            </div>
        </div>
</section>
