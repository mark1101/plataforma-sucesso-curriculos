        ...
        <div class="header__right">
            <div class="main__menu red--links">
                <ul>
                    ...
                    <li><a href="">FAQ</a></li>
                    <li><a href="">Suporte</a></li>
                    <li><a href=""><span><img src="assets/img/icons/cart-2.png" alt=""></span></a></li>
                </ul>
            </div>
            <div class="menu-open">
                    ...
                    <form action="">
                        <div class="card">
                            <div class="single__input__item mb-0">
                                <input type="text" placeholder="Busca por ID" class="form-control">
                                <button class="src-btn"><i class="far fa-search"></i></button>
                            </div>
                        </div>
            ...
            <div class="col-md-9">
                <div class="result__area__right__wrapper">
                    ...
                    <div class="result__items__wrapper">
                        <div class="single__result__item">
                            <div class="single__result__item__top">
                                <p>ID do currículo: 123456</p>
                            </div>
                            <div class="single__result__item__body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <p>Função que Atuou: <b>Vendedor</b></p>
                                    </div>
                                    <div class="col-sm-6">
                                        <p>Escolaridade: <b>Superior Completo</b></p>
                                    </div>
                                    <div class="col-sm-6">
                                        <p>Tempo de Experiência:
                                            <b> 4 anos e 6 meses</b>
                                        </p>
                                    </div>
                                    <div class="col-sm-6">
                                        <p>Formação:
                                    ...
                                    <div class="col-sm-6">
                                        <p>Ramo da Empresa que Atuou: <b>Automóveis</b></p>
                                    </div>
                                    <div class="col-sm-6">
                                        <p>Salário Pretendido:<b> R$4.000,00 - R$6.000,00</b></p>
                                    </div>
                                </div>
                            </div>
                            <div class="single__result__item__bottom">
                                <p><span><i class="fas fa-map-marker-alt"></i></span> Guarapuava/Paraná</p>
                                <div class="single__result__item__bottom__right">
                                    <div class="add__to__favourite">Adicionar aos favoritos <span
                                            class="favourite__btn"><i class="far fa-star"></i></span></div>
                                    <div class="add__cart__btn"><button>Colocar no carrinho</button></div>
                                </div>
                            </div>
                        </div>
                        <div class="single__result__item">
                        ...
                        <div class="single__result__item">
                            ...
                            <div class="single__result__item__bottom">
                                ...
                                <div class="single__result__item__bottom__right">
                                    <div class="add__to__favourite">Adicionar aos favoritos <span
                                            class="favourite__btn"><i class="far fa-star"></i></span></div>
                                    <div class="already__downloaded__alert">
